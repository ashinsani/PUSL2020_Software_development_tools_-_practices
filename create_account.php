...
if (isset($_GET['success'])) {
    echo "<div class='alert alert-success' role='alert'>New student profile created successfully.</div>";
}
...
<div class="container">
        <h2 class="text-center">Create Student Profile</h2>
        <form action="create_student_profile.php" method="post" class="form-signin">
