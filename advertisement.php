...
$sql = "SELECT id, name, description, price, latitude, longitude, image FROM property_listing where status = 'Pending'";
        ...
        <div class="card card-horizontal">
            ...
            <div class="card-body-horizontal">
                ...
                <div class="action-buttons">
                    <a href="approve.php?id=<?php echo $listing['id']; ?>" class="btn btn-primary btn-update">Approve</a>
                    <a href="reject.php?id=<?php echo $listing['id']; ?>" class="btn btn-danger btn-delete" onclick="return confirm('Are you sure you want to reject this listing?');">Reject</a>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
